...
lats[[7]] = seq(which(lat2 == -24), which(lat2 == -15), by = 1)
...
lons[[7]] = seq(which(lon2 == 305), which(lon2 == 330), by = 1)
...
lats.area[[7]] = seq(which(lat == -27.5), which(lat == -15.5), by = 1)
...
lons.area[[7]] = seq(which(lon == 300.5), which(lon == 315.5), by = 1)
