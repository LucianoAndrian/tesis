...
mapa_topo3(variable = estaciones_prom_t, lon = lon2, lat = lat2, resta = 273, colorbar = "Spectral", niveles = 11
           , mapa = "SA", na.fill = -10000, r = 4, estaciones = T, altura.topo = 1500, width = 20, height = 20
           , label.escala = "ºC", escala = seq(0, 35, by = 2.5), revert = T, titulo = "Temperatura - CPC"
           , nombre.fig = "temp_cpc", salida = "/salidas/observado/") 
...
mapa_topo3(variable = standar_d_t, lon = lon2, lat = lat2, colorbar = "YlOrRd", niveles = 9
           , mapa = "SA", na.fill = -10000, r = 4, estaciones = T, altura.topo = 1500, width = 20, height = 20
           , label.escala = "ºC" , escala = seq(0, 1.5, by = 0.1), revert = F, titulo = "SD Temperatura - CPC"
           , nombre.fig = "sd_TEMP_cpc", salida = "/salidas/observado/") 
...
pp3_int = array(NA, dim = c(58, 78, 360)) 
...
for( i in 1:4){
  estaciones_prom_pp3[,,i] = apply(estaciones_p_a_pp3[,,,i], c(1,2), mean)*mask2
                                                ...
                                                #### atado con alambre... \m/
mapa_topo3(variable = estaciones_prom_pp3, lon = c(274,lon2, 331), lat = c(-61,lat2,16), resta = 0
           , colorbar = "PuBuGn", niveles = 9, mapa = "SA", na.fill = -10000, r = 4, estaciones = T
           , altura.topo = 1500, width = 20, height = 20, label.escala = "mm", escala = seq(0, 400, by = 50)
           , revert = F, titulo = "Precipitación - CMAP", nombre.fig = "pp_cmap", salida = "/salidas/observado/") 
...
mapa_topo3(variable = standar_d_pp3, lon = c(274,lon2, 331), lat = c(-61,lat2,16), resta = 0
           , colorbar = "PuBuGn", niveles = 9, mapa = "SA", na.fill = -10000, r = 4, estaciones = T
           , altura.topo = 1500, width = 20, height = 20, label.escala = "mm", escala = seq(0, 70, by = 5)
           , revert = F, titulo = "SD Precipitación - CMAP", nombre.fig = "sd_PP_cmap", salida = "/salidas/observado/") 
...
mapa_topo3(variable = dif_pp1_2, lon = pp_aux$x[2:57], lat = pp_aux$y[2:77], resta = 0
           , colorbar = "BrBG", niveles = 9, mapa = "SA", na.fill = -10000, r = 4, estaciones = T, altura.topo = 1500
           , width = 20, height = 20, label.escala = "mm", escala = seq(-50, 50, by = 10), revert = F
           , titulo = "PP - CPC vs GPCC", nombre.fig = "dif_pp_cpc-gpcc", salida = "/salidas/observado/") 


mapa_topo3(variable = dif_pp1_3, lon = pp_aux$x[2:57], lat = pp_aux$y[2:77], resta = 0
           , colorbar = "BrBG", niveles = 9, mapa = "SA", na.fill = -10000, r = 4, estaciones = T, altura.topo = 1500
           , width = 20, height = 20, label.escala = "mm", escala = seq(-50, 50, by = 10), revert = F
           , titulo = "PP - CPC vs CMAP", nombre.fig = "dif_pp_cpc-cmap", salida = "/salidas/observado/") 

mapa_topo3(variable = dif_pp2_3, lon = pp_aux$x[2:57], lat = pp_aux$y[2:77], resta = 0
           , colorbar = "BrBG", niveles = 9, mapa = "SA", na.fill = -10000, r = 4, estaciones = T, altura.topo = 1500
           , width = 20, height = 20, label.escala = "mm", escala = seq(-50, 50, by = 10), revert = F
           , titulo = "PP - GPCC vs CMAP", nombre.fig = "dif_pp_gpcc-cmap", salida = "/salidas/observado/") 
